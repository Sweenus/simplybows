...
public class BubbleBountyVisualEntity extends Entity {

    private static final TrackedData<Float> HEIGHT_SCALE = DataTracker.registerData(BubbleBountyVisualEntity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Float> RADIUS = DataTracker.registerData(BubbleBountyVisualEntity.class, TrackedDataHandlerRegistry.FLOAT);
    private static final TrackedData<Float> COLUMN_HEIGHT = DataTracker.registerData(BubbleBountyVisualEntity.class, TrackedDataHandlerRegistry.FLOAT);

    public BubbleBountyVisualEntity(EntityType<? extends BubbleBountyVisualEntity> type, World world) {
        super(type, world);
        this.noClip = true;
        this.setNoGravity(true);
    }

    public BubbleBountyVisualEntity(World world, double x, double y, double z) {
        this(EntityRegistry.BUBBLE_BOUNTY_VISUAL.get(), world);
